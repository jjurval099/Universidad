 ...
 */
public class UniversidadExceptions extends Exception
{
	/**
	 * Serial Version UID
	 */
	 ...
	 */
	public UniversidadExceptions(int code, String message) 
	{
		super(message);
	 ...
	 */
	public UniversidadExceptions(int code, String message, Exception exception) 
	{
